...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.registerBlockType)("udemy-plus/recipe-summary", {
  ...
  edit(_ref) {
    ...
    }, isLoading && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__.Spinner, null), !isLoading && cuisines && cuisines.map((item, i) => {
      const comma = cuisines[i + 1] ? ", " : "";
